            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Select Company Info Category</h4>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-12 col-lg-6 category-class">
                                    <div class="form-group"> 
                                        ...
                                        <select name="category" id="company_category" class="form-control">
                                            <option value="">Select Company Info Category</option>
