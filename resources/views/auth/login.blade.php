...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <head>
    ...
    <title>Login Page - Clean Check</title>
...
<link href="{{ asset('/dashboard/assets/css/css2.css?family=Montserrat:ital,wght@0,300;0,400;0,500;0,600;1,400;1,500;1,600') }}" rel="stylesheet">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('/dashboard/app-assets/css/pages/page-auth.min.css') }}">
    <!-- END: Page CSS-->
  ...
  <div class="auth-inner py-2">
    ...
    <div class="card mb-0">
      <div class="card-body">
        ...
        <h4 class="card-title mb-1 text-center">Welcome to Admin Login</h4>
        ...
        <form class="auth-login-form mt-2" action="{{ url()->full() }}" method="POST" autocomplete="off">
            @csrf
          ...
          <div class="form-group mb-3">
            ...
            <div class="input-group input-group-merge form-password-toggle">
              <input type="password" autocomplete="new-password" class="form-control form-control-merge" id="login-password" name="password" tabindex="2" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" aria-describedby="login-password">
